                                                                        ...
                                                                        <tbody id="dati_fatture">
                                                                            ...
                                                                            ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <td><button class="btn btn-primary btn-sm vediliquidazione" data-id="<?= $liquidazione['id'] ?>"><i class="fe fe-eye" data-bs-toggle="tooltip" title="" data-bs-original-title="fe fe-eye" aria-label="fe fe-eye"></i></button>
                                                                                        ...
                                                                                        <a href="pdf.php?id_liquidazione=<?= $liquidazione['id'] ?>" class="btn btn-warning btn-sm" target="_blank"><i class="fe fe-file-text"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                            <?php } ?>
                                                                        </tbody>
